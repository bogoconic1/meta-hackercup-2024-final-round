...
class Problem:
    ...
    def save_code(self, code: str, code_path: Optional[str] = None, outfile_name: Optional[str] = None):
        ...
        logging.info("Code saved to", code_path)
    ...
    def from_files(cls, name: str, description_path: Path, sample_input_path: Path, 
        ...
        return cls(
            name=name,
            problem_description=description_path.read_text(encoding='utf-8'),
            sample_input=sample_input_path.read_text(encoding='utf-8'),
    ...
    @classmethod
    def find_all(
        cls, folder_path: Path, is_2024=True, on_sample=False
    ) -> List["Problem"]:
        problems = []
        ...
        if is_2024:
            ...
            for problem_folder in problem_folders:
                ...
                #if not on_sample:
                    #required_files.append("full_out.txt")
                ...
                if all(
                    ...
                    try:
                        problem = cls.from_name(problem_name, problem_folder)
